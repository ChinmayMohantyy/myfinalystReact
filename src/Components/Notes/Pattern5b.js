...
import SubPattern5b from './SubPattern5b';
...
export default function Pattern5(props) {
  ...
  arr1[1] = data
  setNote(arr1)
  console.log(arr1,'handle note 1')
    ...
    return (
      <div style={{paddingTop:'2rem'}}>
        ...
        <TabPanel  value={value} index={0}>
           <SubPattern5b data={note[1]} handleNote={handleNote1} title='current' ix = {1} />
        </TabPanel>
        <TabPanel  value={value} index={1}>
           <SubPattern5b data={note[0]} handleNote={handleNote2} title='noncurrent' ix = {0} />
        </TabPanel>
