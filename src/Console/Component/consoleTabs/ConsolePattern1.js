...
function ConsolePattern1(props) {
                    ...
                    return (
                      <>
                        {sub.sub_grp.map((sub_grp, i) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td style={{ width: "25%" }}>
                                {brackets(sub_grp.cy_amt?sub_grp.cy_amt:"-")}
                              </td>
                              <td style={{ width: "25%" }}>
                                {brackets(sub_grp.py_amt?sub_grp.py_amt:"-")}
                              </td>
                        ...
                        <tr>
                          ...
                          <td style={total}>{brackets(sub_cy?sub_cy:"-")}</td>
                          <td style={total}>{brackets(sub_py?sub_py:"-")}</td>
...
export default ConsolePattern1
