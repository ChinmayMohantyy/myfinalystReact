          ...
          {grouping &&
            grouping.grp.map((line, index) => {
                      ...
                      if (i === lastEle) {
                        ...
                        return (
                          <>
                            ...
                            {/* <tr>
                              <td
                                onClick={(e) => handleAdd("Non Current Assets")}
                                style={{
                                  width: "50%",
                                  textAlign: "left",
                                  fontWeight: "600",
              ...
              if (index == 1) {
                return line.notes_grp.map((sub, ix) => {
                  if (sub.notes_no == noteNumber) {
                    console.log(sub.sub_grp, "hre mapi");
                    const lastEle = sub.sub_grp.length - 1;
                    ...
                    console.log(sub_py, sub_cy, "sub_cysub_cysub_cysub_cy");
                    return sub.sub_grp.map((sub_grp, i) => {
                      if (highlight.row === ix && highlight.sub === i) {
                        console.log("matched ");
                      }
                      if (i === 0 && i === lastEle) {
                        return (
                          <>
                            ...
                            {/* <tr>
                              <td
                                onClick={(e) => handleAdd("Current Assets")}
                                style={{
                                  width: "50%",
                                  textAlign: "left",
                                  fontWeight: "600",
...
export default ConsolePattern2;
